		...
		<el-row :gutter='10' class='address'>
			...
			<el-col :span='6'>
				<el-form-item prop='county'>
					<el-select v-model='form.county' placeholder='请选择区/县' @change='countyChange'>
						<el-option
...
Vue.use(Element)
  ...
  export default {
    name: 'address',
    props: ['province', 'city', 'county', 'detail'],
    data: function () {
      return {
        rules: {
    ...
    computed: {
      ...
      countys: function (){
        if(this.form.city){
          return formatCounty(addressData[this.form.province][this.form.city])
        }
      }
    },
    methods: {
